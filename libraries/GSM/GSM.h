...
// pins definition
#define GSM_ON              46 // connect GSM Module turn ON to pin 5 
#define GSM_RESET          47 // connect GSM Module RESET to pin 4 
//#define DTMF_OUTPUT_ENABLE  2 // connect DTMF Output Enable to pin 2
#define DTMF_DATA_VALID     14 // connect DTMF Data Valid to pin 3
#define DTMF_DATA0          72 // connect DTMF Data0 to pin 6
#define DTMF_DATA1          73 // connect DTMF Data1 to pin 7
#define DTMF_DATA2          74 // connect DTMF Data2 to pin 8
#define DTMF_DATA3          75 // connect DTMF Data3 to pin 9
